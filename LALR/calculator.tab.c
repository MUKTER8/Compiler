...
{
       2,     0,     1,    12,     0,     3,     0,     7,    10,     0,
       4,     0,     0,     0,     0,    11,     5,     6,     8,     9
};
...
{
       2,     3,     0,     3,    13,    14,     9,     4,     0,     4,
      11,    12,    10,    11,    12,    15,     0,    16,    17,     0,
      18,    19
};
...
{
       0,    12,     0,     3,     9,    13,    14,    15,    16,    14,
       4,     5,     6,     7,     8,    10,    15,    15,    16,    16
};
...
#line 22 "calculator.y"
                      { printf("= %g\n", (yyvsp[-1].dval)); }
#line 1079 "calculator.tab.c"
    break;

  case 5: /* expr: expr '+' term  */
#line 25 "calculator.y"
                          { (yyval.dval) = (yyvsp[-2].dval) + (yyvsp[0].dval); }
#line 1085 "calculator.tab.c"
    break;

  case 6: /* expr: expr '-' term  */
#line 26 "calculator.y"
                          { (yyval.dval) = (yyvsp[-2].dval) - (yyvsp[0].dval); }
#line 1091 "calculator.tab.c"
    break;

  case 7: /* expr: term  */
#line 27 "calculator.y"
                          { (yyval.dval) = (yyvsp[0].dval); }
#line 1097 "calculator.tab.c"
    break;

  case 8: /* term: term '*' factor  */
#line 30 "calculator.y"
                          { (yyval.dval) = (yyvsp[-2].dval) * (yyvsp[0].dval); }
#line 1103 "calculator.tab.c"
    break;

  case 9: /* term: term '/' factor  */
#line 31 "calculator.y"
                          { (yyval.dval) = (yyvsp[-2].dval) / (yyvsp[0].dval); }
#line 1109 "calculator.tab.c"
    break;

  case 10: /* term: factor  */
#line 32 "calculator.y"
                          { (yyval.dval) = (yyvsp[0].dval); }
#line 1115 "calculator.tab.c"
    break;

  case 11: /* factor: '(' expr ')'  */
#line 35 "calculator.y"
                          { (yyval.dval) = (yyvsp[-1].dval); }
#line 1121 "calculator.tab.c"
    break;

  case 12: /* factor: DIGIT  */
#line 36 "calculator.y"
                          { (yyval.dval) = (yyvsp[0].dval); }
#line 1127 "calculator.tab.c"
    break;


#line 1131 "calculator.tab.c"
